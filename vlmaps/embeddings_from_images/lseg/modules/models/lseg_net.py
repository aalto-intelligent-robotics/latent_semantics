...
class LSegEnc(BaseModel):
    def __init__(
        ...
        **kwargs,
        ...
        # print('Loading CLIP pretrained...', cuda_info())
        ...
        self.clip_pretrained, self.pretrained, self.scratch = _make_encoder(
            ...
            use_readout=readout,
            clip_path=os.environ['VLMAPS_DIR'] + '/ViT-B-32.pt'
        )

        # print("Making scratch layers...", cuda_info())
        ...
        # print("Preprocessing text...", cuda_info())

        # self._preprocess_fixed_text()

        # print('Done model init.', cuda_info())


    # def _preprocess_fixed_text(self):
    #     self.text = clip.tokenize(self.labels).cuda()
    #     self.text_features = self.clip_pretrained.encode_text(self.text)
    ...
    def forward(self, x, labelset):
        ...
        # logits_per_image = pixel_encoding @ self.text_features.t()
        ...
        return pixel_encoding, None # out
