...
def _make_pretrained_clip_vitl16_384(pretrained, use_readout="ignore", hooks=None, enable_attention_hooks=False, clip_path="ViT-B/32"):
    # clip_pretrained, _ = clip.load(clip_path, device="cuda", jit=False)
