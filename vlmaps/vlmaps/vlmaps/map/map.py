...
class Map:
    ...
    def _setup_paths(self, data_dir: Union[Path, str]) -> None:
        ...
        self.semantic_dir = self.data_dir / "semantic-rt"
        self.region_dir = self.data_dir / "regions"
        ...
        try:
            ...
            self.region_paths = sorted(self.region_dir.glob("*.npy"))
