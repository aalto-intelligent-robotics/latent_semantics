...
def find_similar_category_id_static(class_name, classes_list):
    ...
    if(class_name == "unlabeled"):
        ...
        raise Exception("No pre-queried value in find_similar_category_id_static for", class_name)
    classes_list.index(result)
...
def get_segment_islands_pos(segment_map, label_id, detect_internal_contours=False):
    ...
    return contours_list, centers_list, bbox_list, hierarchy, mask
